...
<form name="supplier" id="validate" class="form" action="index.html?com=cate&act=save_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
                <div class="mt10"><img src="<?=_upload_cate.$item['thumb']?>"  alt="NO PHOTO" width="<?=$rong?>" height="<?=$cao?>" /></div>
                <a href="index.html?com=cate&act=save_list&id=<?=$item['id']?>&xoaanh=xoaanh<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><img src="Assets/images/icons/dark/close.png" /></a><br />
             </div>
			<div class="clear"></div>
		</div>
		<?php } } ?>
