...
<form name="supplier" id="validate" class="form" action="index.html?com=link&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <?php if(in_array('ficon',$config_open)){ ?>
        <div class="formRow">
            <label>Icon  </label>
            <div class="formRight">
                <input type="text" name="ficon" title="Nhập icon" id="ficon" class="tipS" value="<?=@$item['ficon']?>" />
            </div>
            <div class="clear"></div>
        </div>
        <?php } ?>
		...
		<?php if(in_array('phone',$config_open)){ ?>
		<div class="formRow">
			<label>Hotline</label>
			<div class="formRight">
                <input type="text" name="ficon" title="Nhập hotline" id="ficon" class="tipS validate[required]" value="<?=@$item['ficon']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
        ...
        <?php if(in_array('attributes',$config_open)){ $attributes = json_decode($item['attributes'],true);?>
            <div class="formRow">
                <label>Email</label>
                <div class="formRight">
                    <input type="text" name="attributes[email]" title="Nhập email" class="tipS validate[required]" value="<?=$attributes['email']?>" />
                </div>
                <div class="clear"></div>
            </div>
            <div class="formRow">
                <label>Hotline</label>
                <div class="formRight">
                    <input type="text" name="attributes[hotline]" title="Nhập hotline" class="tipS validate[required]" value="<?=$attributes['hotline']?>" />
                </div>
                <div class="clear"></div>
            </div>
            <div class="formRow">
                <label>Địa chỉ</label>
                <div class="formRight">
                    <input type="text" name="attributes[address]" title="Nhập address" class="tipS validate[required]" value="<?=$attributes['address']?>" />
                </div>
                <div class="clear"></div>
            </div>
        <?php } ?>
